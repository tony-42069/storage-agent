...
from src.services.storage_service import StorageService, StorageUnit, Reservation


@pytest.fixture
def storage_service():
    """Fixture to provide a StorageService instance with mock client."""
...
def test_pricing_tiers(storage_service):
    ...
    assert unit_prices["5x5"] < unit_prices["10x10"]
